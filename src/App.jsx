  ...
  return (
    <div className="App">
      ...
      <section className="how-it-works py-4">
        ...
        <button className="btn btn-info"><a href='https://docs.google.com/forms/d/e/1FAIpQLSd-rhvHXavyXyFFGbBTTSgRKw7jLmUJtWKw0g24oF2mgHrIQA/viewform?usp=sharing' style={{color: 'white'}} target='blank'>Client Feedback form</a></button>
      </section>
    </div>
  );
}
